...
type KubeltClient interface {
	...
	RegisterUser(ctx context.Context, in *ApplyRequest, opts ...grpc.CallOption) (*ApplyResponse, error)
...
func (c *kubeltClient) RegisterUser(ctx context.Context, in *ApplyRequest, opts ...grpc.CallOption) (*ApplyResponse, error) {
	out := new(ApplyResponse)
	err := c.cc.Invoke(ctx, "/kubelt.Kubelt/RegisterUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KubeltServer interface {
	...
	RegisterUser(context.Context, *ApplyRequest) (*ApplyResponse, error)
...
func _Kubelt_RegisterUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KubeltServer).RegisterUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kubelt.Kubelt/RegisterUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeltServer).RegisterUser(ctx, req.(*ApplyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Kubelt_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Kubelt_RegisterUser_Handler,
		},
		{
			MethodName: "Get",
